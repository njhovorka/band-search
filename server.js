...
var bandText = fs.readFileSync("./public/fake_band_names_mit.txt", "utf-8");
...
// returns a json array containing artists and their scores relating to the search query.
// O(n) complexity - iterates over array once
...
// returns a json array with the artists ranked by their similarity scores.
 // O(n) complexity - iterates over array twice
function rankArtists(query){
  ...
  var rankedArtists = [];
  // replace similarity score with rank overall
